...
export type CoordinationResource={id:string;project_id:string;label:string;hash?:string|null;captured_hash?:string|null;fresh?:boolean;missing?:boolean;discipline?:string|null;status?:string|null;criticality?:string|null;confidence?:string|null;schema_version?:string|null;coordinate_system?:string|null;state?:string|null};
...
export type CoordinationItem={
 ...
 source_resource?:{type:string;id:string;label:string;hash:string;captured_hash?:string|null;fresh?:boolean;missing?:boolean}|null;target_resource?:{type:string;id:string;label:string;hash:string;captured_hash?:string|null;fresh?:boolean;missing?:boolean}|null;
