...
export type CoordinationResource={id:string;project_id:string;label:string;hash?:string|null;captured_hash?:string|null;fresh?:boolean;discipline?:string|null;status?:string|null;criticality?:string|null;confidence?:string|null;schema_version?:string|null;coordinate_system?:string|null;state?:string|null};
...
export type CoordinationItem={
 ...
 source_resource?:{type:string;id:string;label:string;hash:string;captured_hash?:string|null;fresh?:boolean}|null;target_resource?:{type:string;id:string;label:string;hash:string;captured_hash?:string|null;fresh?:boolean}|null;
 resources_current:boolean;coordination_hash:string;resolution_note?:string|null;resolution_evidence_refs:string[];accepted_deviation_approval_id?:string|null;created_by?:string|null;resolved_by?:string|null;resolved_at?:string|null;created_at:string;updated_at:string;
};
